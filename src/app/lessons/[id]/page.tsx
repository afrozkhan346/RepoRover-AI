  ...
  const links = [
    {
      ...
      description: "Browse the learning routes that remain in the migrated app.",
    },
    {
      href: "/dashboard",
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.16),_transparent_32%),linear-gradient(180deg,_#f8fbff_0%,_#eef6ff_100%)] px-6 py-16">
      <section className="mx-auto w-full max-w-4xl rounded-[2rem] border border-slate-200/80 bg-white/90 p-8 shadow-2xl backdrop-blur">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-slate-900">Lesson details are handled locally.</h1>
          <p className="max-w-2xl text-base leading-7 text-slate-600">
            This route now acts as a clean placeholder inside the migrated stack and stays within the current frontend.
          </p>
        </div>
